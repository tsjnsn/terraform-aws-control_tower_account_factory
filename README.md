...
| <a name="input_azuredevops_url"></a> [azuredevops\_url](#input\_azuredevops\_url) | Azure DevOps Server URL, if Azure DevOps Server is being used | `string` | `"null"` | no |
...
| <a name="input_vcs_provider"></a> [vcs\_provider](#input\_vcs\_provider) | Customer VCS Provider - valid inputs are codecommit, bitbucket, github, githubenterprise, gitlab, gitlabselfmanaged, or azuredevops (Azure DevOps support pending AWS implementation) | `string` | `"codecommit"` | no |
...
| <a name="output_azuredevops_url"></a> [azuredevops\_url](#output\_azuredevops\_url) | n/a |
